    ...
    <div class="span12">
        <div class="box">
            ...
            <div class="box-content">
                <form action="<?= base_url()."$level" ?>/kuliah" role="form" method="post" class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label">Hari</label>
                        <div class="controls">
                            <select name="id_hari">
                                <?php
                                foreach ($hari->result_array() as $v) {
                                    echo "<option value='$v[id_hari]'>$v[hari]</option>";
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="mulai" placeholder="Mulai" class="timepicker-24 span2" required="">
                            <input type="text" name="selesai" placeholder="Selesai" class="timepicker-24 span2" required="">
                        </div>
                    </div>
                    <div class="control-group">
