    ...
    <div class="span12">
        <div class="box">
            ...
            <div class="box-content">
                <form action="<?= base_url()."$level" ?>/mahasiswa" role="form" method="post" class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label">NIM</label>
                        <div class="controls"><input type="text" name="nim" required="" maxlength="20" value="<?= $nim ?>" class="form-control span4">
                        </div>
                    </div>
                    <div class="control-group">
